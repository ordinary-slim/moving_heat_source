...
def main(dataSet, isCoupled):
    ...
    UpdatePipeline(time=10.0498, proxy=coupled_safepvd)
    ...
    UpdatePipeline(time=10.0498, proxy=threshold1)
    ...
    plotOverLine1.Point1 = [-6.0, 0.0, 0.12499]
    plotOverLine1.Point2 = [6.0, 0.0, 0.12499]

    UpdatePipeline(time=10.0498, proxy=plotOverLine1)

    # save data
    PointDataArrays = ['T', 'material']
    if isCoupled:
        PointDataArrays.append( 'gammaNodes' )
    SaveData('/home/mslimani/Documents/dd_methodology_paper/figures/3d_lpbf/plots/endFifthLayer_{}.csv'.format(dataSetName), proxy=plotOverLine1, ChooseArraysToWrite=1,
