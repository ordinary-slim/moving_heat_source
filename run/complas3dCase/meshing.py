...
def getMeshPhysical(popup=False):
    ...
    # Part extrusion
    nelsPartZ = partLens[2] / layerThickness # 1 el / layer
    ...
    nElements, heights = boundaryLayerProgression( lenCoarseBotExtrusion, nBounLayers, fineElSize, coarseElFactor=2 )
    ...
    nElements, heights = boundaryLayerProgression( lenCoarseYExtrusion, nBounLayers, fineElSize, coarseElFactor=2 )
    ...
    nElements, heights = boundaryLayerProgression( extrusionLen, nBounLayers, fineElSize, coarseElFactor=2 )
