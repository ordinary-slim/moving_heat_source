...
class CustomStepper(AdaptiveStepper):
    ...
    def writepos( self ):
        self.pFixed.writepos(
            ...
            cellMeshTags={
                "matSets":self.pFixed.domain.materialTag,
        ...
        self.pMoving.writepos(
            ...
            cellMeshTags={
                "matSets":self.pMoving.domain.materialTag,
            },
            )
...
class DriverReference:
    ...
    def writepos(self):
        self.problem.writepos(
                cellMeshTags={
                    "matSets":self.problem.domain.materialTag,
                },
                functions={
    ...
    def iterate( self ):
        ...
        if ((track.hasDeposition) and (self.printer is not None) and (self.problem.input["print"])):
            self.printer.melt( self.problem.mhs.position,
